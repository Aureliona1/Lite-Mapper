...
export class Chain extends GameplayObject {
	 ...
	 */
	constructor(public time = 0, pos: Vec2 = [0, 0], public type: ObjectColorName = "Left", public direction: ObjectDirectionName = "Down", public tailBeat = 1, public tailPos: Vec2 = [0, 0], public segments = 5) {
		super(pos);
	}
